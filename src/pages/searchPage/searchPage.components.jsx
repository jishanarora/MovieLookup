    ...
    <SearchPageContainer>
      ...
      {getNominationsCount > 4 ? (
        <Alert
          ...
          message="You have selected the maximum allowed nominations, If you want to change your selections"
          banner
        />
      ) : null}
      <SearchFormContainer>
      ...
      {loading ? (
        ...
        <Row gutter={[20, 60]}>
          {movies
            ? movies.map((movie) => (
                <Col lg={6} md={6} sm={8} xs={22}>
                  <CollectionItem Key={movie.imdbID} item={movie} />
                </Col>
              ))
            : null}
        </Row>

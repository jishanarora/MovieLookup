...
import {NominationItem, ImageContainer, TitleContainer, RemoveButton} from './nomination-items.styles'
...
return(
    ...
    <RemoveButton onClick={()=>dispatch(removeNomination(movie))}>&#10005;</RemoveButton>   
</NominationItem>
);
}
